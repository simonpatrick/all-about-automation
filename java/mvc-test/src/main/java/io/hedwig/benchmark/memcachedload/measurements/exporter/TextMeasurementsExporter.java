 ...
 * LICENSE file.                                                                                                                                                                   
 */
package io.hedwig.benchmark.memcachedload.measurements.exporter;
...
public class TextMeasurementsExporter implements MeasurementsExporter {
	...
	public void write(String metric, String measurement, String message)
	throws IOException {
		bw.write("[" + metric + "] " + measurement + ", " + message);
		bw.newLine();
	}
